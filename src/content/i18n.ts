...
const englishLabels: PanelLabels = {
  ...
  interactionLibraryOpen: "Open interaction dictionary",
  interactionLibraryTooltip: "Browse information relationships and try lightweight interaction micro-demos.",
...
const chineseLabels: PanelLabels = {
  ...
  interactionLibraryOpen: "打开交互小字典",
  interactionLibraryTooltip: "按信息关系查找，并体验轻量交互微演示。",
  copyFailed: "复制失败",
  addIntent: "添加修改意见",
